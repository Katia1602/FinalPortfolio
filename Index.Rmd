...
By working within teams on the majority of these assignments, I learned a lot of tricks and tips from my peers, which might be reflected below in some of my work. Some color schemes in these maps were inspired by my teammates, from which I learned the techniques on how to make my maps more visually appealing. 
